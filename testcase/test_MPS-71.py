...
def test_split_page(username='wellyadmin',
    ...
    _, page_one = teamlist.ag_team_list_search(username,
                                                  status='0',
                                                  level='0',
                                                  searchValue=None,
                                                  searchField='AGENT',
                                                  ...
                                                  limit='25',
                                                  offset='0',)
    _, page_two = teamlist.ag_team_list_search(username,
                                                 status='0',
                                                 level='0',
                                                 searchValue=None,
                                                 searchField='AGENT',
                                                 ...
                                                 limit='25',
                                                 offset='25',)
    _, team_list50 = teamlist.ag_team_list_search(username,
                                                   status='0',
                                                   level='0',
                                                   searchValue=None,
                                                   searchField='AGENT',
                                                   ...
                                                   limit='50',
                                                   offset='0',)
    _, team_list100 = teamlist.ag_team_list_search(username,
                                                   status='0',
                                                   level='0',
                                                   searchValue=None,
                                                   searchField='AGENT',
